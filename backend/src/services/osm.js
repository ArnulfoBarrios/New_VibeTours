...
export const KNOWN_ICONIC_LANDMARKS = {
  ...
  'isla mucura': { name: 'Isla Múcura, Archipiélago de San Bernardo', latitude: 9.7818, longitude: -75.8723, city: 'Coveñas', country: 'Colombia', tags: { place: 'islet', tourism: 'attraction', grounded_geocoded: true } },
  'isla tintipan': { name: 'Isla Tintipán, Archipiélago de San Bernardo', latitude: 9.7964, longitude: -75.8364, city: 'Coveñas', country: 'Colombia', tags: { place: 'island', tourism: 'attraction', grounded_geocoded: true } },
  'santa cruz del islote': { name: 'Santa Cruz del Islote, Archipiélago de San Bernardo', latitude: 9.7859, longitude: -75.8590, city: 'Coveñas', country: 'Colombia', tags: { tourism: 'attraction', grounded_geocoded: true }, placeId: 'W/156844543' },
  ...
  'playa blanca': { name: 'Playa Blanca, Coveñas', latitude: 9.4045, longitude: -75.6790, city: 'Coveñas', country: 'Colombia', tags: { natural: 'beach', tourism: 'attraction', grounded_geocoded: true } },
  'playa hermosa': { name: 'Playa Hermosa, Coveñas', latitude: 9.4095, longitude: -75.6720, city: 'Coveñas', country: 'Colombia', tags: { natural: 'beach', tourism: 'attraction', grounded_geocoded: true } },
  'primera ensenada': { name: 'Primera Ensenada de Coveñas', latitude: 9.4020, longitude: -75.6850, city: 'Coveñas', country: 'Colombia', tags: { natural: 'beach', tourism: 'attraction', grounded_geocoded: true } },
  'segunda ensenada': { name: 'Segunda Ensenada de Coveñas', latitude: 9.4210, longitude: -75.6450, city: 'Coveñas', country: 'Colombia', tags: { natural: 'beach', tourism: 'attraction', grounded_geocoded: true } },
  'boca de la cienaga': { name: 'Boca de la Ciénaga, Coveñas', latitude: 9.4310, longitude: -75.6380, city: 'Coveñas', country: 'Colombia', tags: { natural: 'beach', tourism: 'attraction', grounded_geocoded: true } },
  ...
  'kiosko el pescador': { name: 'Kiosko El Pescador', latitude: 9.4070, longitude: -75.6760, city: 'Coveñas', country: 'Colombia', tags: { amenity: 'restaurant', grounded_geocoded: true } },
  'restaurante covenas': { name: 'Restaurante Coveñas', latitude: 9.4022, longitude: -75.6804, city: 'Coveñas', country: 'Colombia', tags: { amenity: 'restaurant', grounded_geocoded: true } },
  'restaurante esmeralda': { name: 'Restaurante Esmeralda', latitude: 9.3970, longitude: -75.7778, city: 'San Antero', country: 'Colombia', tags: { amenity: 'restaurant', grounded_geocoded: true } },
  'playa divina': { name: 'Playa Divina, Coveñas', latitude: 9.4050, longitude: -75.6810, city: 'Coveñas', country: 'Colombia' },
  'playa caiman': { name: 'Playa Caimán, Coveñas', latitude: 9.4080, longitude: -75.6750, city: 'Coveñas', country: 'Colombia' },
  'restaurante el montanero': { name: 'Restaurante el Montañero', latitude: 9.5245, longitude: -75.5852, city: 'Santiago de Tolú', country: 'Colombia', tags: { amenity: 'restaurant', grounded_geocoded: true } },
  ...
  'restaurante cucayo': { name: 'Restaurante Cucayo', latitude: 11.0074, longitude: -74.8174, address: 'Calle 85 # 52-153', city: 'Barranquilla', country: 'Colombia' },
  'cucayo': { name: 'Restaurante Cucayo', latitude: 11.0074, longitude: -74.8174, address: 'Calle 85 # 52-153', city: 'Barranquilla', country: 'Colombia' },
  'cucayo sabor costeno': { name: 'Restaurante Cucayo', latitude: 11.0074, longitude: -74.8174, address: 'Calle 85 # 52-153', city: 'Barranquilla', country: 'Colombia' },
  'cucayo cocina de aqui': { name: 'Restaurante Cucayo', latitude: 11.0074, longitude: -74.8174, address: 'Calle 85 # 52-153', city: 'Barranquilla', country: 'Colombia' },
  ...
  'pozo azul': { name: 'Pozo Azul, Minca', latitude: 11.1341, longitude: -74.1015, city: 'Santa Marta', country: 'Colombia' },
  'cascada marinka': { name: 'Cascada Marinka, Minca', latitude: 11.1170, longitude: -74.1175, city: 'Santa Marta', country: 'Colombia' },
  'casa elemento': { name: 'Casa Elemento, Minca', latitude: 11.1180, longitude: -74.0950, city: 'Santa Marta', country: 'Colombia' },
  'reserva natural el dorado': { name: 'Reserva Natural El Dorado', latitude: 11.1146, longitude: -74.0736, city: 'Santa Marta', country: 'Colombia' },
  'canaveral': { name: 'Cañaveral, Parque Tayrona', latitude: 11.3060, longitude: -73.9300, city: 'Santa Marta', country: 'Colombia' },
  'arrecifes': { name: 'Arrecifes, Parque Tayrona', latitude: 11.2980, longitude: -73.9450, city: 'Santa Marta', country: 'Colombia' },
  'la piscina': { name: 'La Piscina, Parque Tayrona', latitude: 11.2950, longitude: -73.9550, city: 'Santa Marta', country: 'Colombia' },
...
export function arePlacesSimilar(a, b) {
  ...
  const cityHint = (typeof a === 'object' && a?.city) ? a.city : ((typeof b === 'object' && b?.city) ? b.city : '')
  if (arePlaceNamesSemanticallySame(strA, strB, cityHint)) {
    return true
  }
