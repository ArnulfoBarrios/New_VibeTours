...
class Tour {
  ...
  Tour copyWith({
    ...
    String? featuredExperience,
    String? placeHistory,
    String? culturalContext,
    List<String>? availableLanguages,
    List<String>? recommendedAudience,
    String? bestSeason,
    String? recommendedSchedule,
    String? meetingPoint,
    TourLocationInfo? meetingPointInfo,
    List<String>? includes,
    List<String>? excludes,
    List<String>? recommendations,
    List<String>? whatToBring,
    List<String>? tourRules,
    ...
    featuredExperience: featuredExperience ?? this.featuredExperience,
    placeHistory: placeHistory ?? this.placeHistory,
    culturalContext: culturalContext ?? this.culturalContext,
    availableLanguages: availableLanguages ?? this.availableLanguages,
    recommendedAudience: recommendedAudience ?? this.recommendedAudience,
    bestSeason: bestSeason ?? this.bestSeason,
    recommendedSchedule: recommendedSchedule ?? this.recommendedSchedule,
    meetingPoint: meetingPoint ?? this.meetingPoint,
    meetingPointInfo: meetingPointInfo ?? this.meetingPointInfo,
    includes: includes ?? this.includes,
    excludes: excludes ?? this.excludes,
    recommendations: recommendations ?? this.recommendations,
    whatToBring: whatToBring ?? this.whatToBring,
    tourRules: tourRules ?? this.tourRules,
